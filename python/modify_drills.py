...
drill_tool(gcode_dir + "xtc43.txt", Z=-0.015, pecking=True)
drill_tool(gcode_dir + "xtc32.txt", Z=-0.135, pecking=True)
drill_tool(gcode_dir + "xtc3mm.txt", Z=-0.135, pecking=True)
...
drill_tool(gcode_dir + "ytc45.txt", Z=-0.015, pecking=True)
drill_tool(gcode_dir + "ytc3mm.txt", Z=-0.015, pecking=True)
